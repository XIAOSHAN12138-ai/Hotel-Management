      ...
      <el-main class="section text-left">
            ...
            <el-row>
              ...
              <el-col :span="6" class="text-center">
                <router-link to="/changepswd" class="text-plain">
                  <p class="tool-icon">
                    <i class="el-icon-a-051 password"></i>
                  </p>
                  <p class="tool-text">
                    密码设置
                  </p>
              ...
              <el-col :span="6" class="text-center">
                <router-link to="/contact" class="text-plain">
                  <p class="tool-icon">
                    <i class="el-icon-a-032 contact"></i>
                  </p>
                  <p class="tool-text">
                    联系我们
                  </p>
        ...
        <div class="btn-logout">
          <el-button type="danger" class="btn-block" @click="dialogVisible = true">
            <i class="iconfont icon-r-left" style="font-size: 22px;"> 退出登录</i>
          </el-button>
        </div>
      </el-main>

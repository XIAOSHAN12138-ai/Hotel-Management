			...
			<el-main class="section">
				...
				<el-card class="box-card pb-1" style="opacity: 0.95;">
					<div class="text item" style="margin-bottom: 20px;">
						<el-row>
							<el-col :span="16">
								<p class="text-left"><i class="el-icon-location-outline"></i>平遥古城星级宾馆</p>
							</el-col>
						</el-row>
				...
				<el-row class="mt-1">
					<el-card class="mb-1 ml-1 mr-1">
						<div class="text item">
							<el-button type="primary" icon="el-icon-a-042" style="font-size: 16px;" class="btn-block" @click="searchBtn">查找空余房间</el-button>
						</div>
					</el-card>

        ...
        <el-card class="box-card changepswd-card">
          <div class="text item">
            <p class="changepswd-title">
              <i class="iconfont icon-r-lock" style="font-size: 34px;"></i> 
              修改密码
            </p>
            ...
            <el-button :type="btnType" @click="changepswdBtn"  style="font-size: 22px;" class="changepswdbtn" :disabled="disabled">
              <i :class="iconstyle" style="font-size: 22px;"></i> 修改
            </el-button>
            <el-button @click="back" style="font-size: 22px;">
              <i class="iconfont icon-r-left" style="font-size: 22px;"></i> 返回</el-button>
          </div>
        </el-card>
      </el-main>
    </el-container>
